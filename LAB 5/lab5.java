...
public class lab5 {
    ...
    // Creating arrays to store student regist numbers, name,email ids, phone
    // number, class and the department
    ...
    public static void main(String[] args) {
        ...
        // infinte loop that stops executing when the user enters exit when prompted to
        // enter a choice
        while (true) {
            ...
            if (choice.equalsIgnoreCase("exit")) {
                ...
                switch (ch) {
                    ...
                    default:
                        // if the user were to enter any other value other than the options provided
                        // displa an appropriate error message
    ...
    // function that reads student details, validates the input and then adds it to
    // the array
    void addStudent() {
        ...
        if (count < 100) {
            ...
            // incrementing the count to indicate a new student has been added to the
            // database
            count += 1;
            ...
            int m = sc.nextInt();
            System.out.println("---------------------------------------------------------");
            // 1 indicates the user would like to create the file with the students data is
            // stored
            if (m == 1) {
                try {
    ...
    void displayStudent() {
        if (count == 0) {
            System.out.println("=========================================================");
            System.out.println("          No students in our database: ");
            System.out.println("=========================================================\n");
        } else {
            System.out.println("=========================================================");
    ...
    public boolean checkEmail(String email) {
        ...
        // display an appropriate message when the email does not contain
        // 'christuniversity.in'
